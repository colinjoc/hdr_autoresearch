...
The GMAW → GTAW transfer MAE (3.95 mm) is 5.5 × higher than the
...
"transfer works". **H20 REFUTED.** The GTAW → GMAW direction is
...
*sufficient*. The missing variance lives in the thin-/thick-plate
