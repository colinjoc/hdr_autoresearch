...
- The observation — itself methodological — that single-fixture per-shot likelihood-informativeness comparisons are seed-fragile (Figure 3). Earlier drafts quoted a 1.65× ratio; it is withdrawn pending multi-fixture statistics.
